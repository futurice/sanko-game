...
public class Star {
    static private final String TEXTURE_PATH = "images/Star.png";
    ...
    public static Star spawnFromScreenBorder(final float screenWidth, final float screenHeight) {
        final Star duck = new Star();
