...
public class Horse {
    static private final String TEXTURE_PATH = "images/Horse.png";
    ...
    public static Horse spawnFromScreenBorder(final float screenWidth, final float screenHeight) {
        final Horse duck = new Horse();
